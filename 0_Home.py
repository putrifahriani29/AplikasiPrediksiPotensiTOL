...
def display_date_time():
    ...
    st.markdown(
        f"""
        <div style="text-align: right; color: #0F2167; border-radius: 25%; display: inline-block; font-size: medium; text-shadow: 3px red; padding: 2%; margin-left: 65%; font-weight: bold; text-decoration: underline;">
...
st.info('Dokumentasi project ini dapat dilihat di GitHub: [AplikasiPrediksiPotensiTOL](https://github.com/putrifahriani29/AplikasiPrediksiPotensiTOL)')
